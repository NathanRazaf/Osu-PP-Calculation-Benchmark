...
async function addPlayDataUser(playId, item, mods) {
    ...
    if (!maybePlay) {
        ...
        const playData = {
            ...
            combo: item.max_combo || 0,
            nmiss: item.statistics.miss || 0,
            hitJudgement: item.beatmap.accuracy || 0,
            approachRate: item.beatmap.ar || 0,
            circleSize: item.beatmap.cs || 0,
            circleCount: item.beatmap.count_circles || 0,
            sliderCount: item.beatmap.count_sliders || 0,
            spinnerCount: item.beatmap.count_spinners || 0,
            ...
            bpm: item.beatmap.bpm || 0,
            hitLength: item.beatmap.hit_length || 0,
            drainRate: item.beatmap.drain || 0,
            rating: item.beatmap.difficulty_rating || 0,
            EZ: mods.includes('EZ'),
            HT: mods.includes('HT'),
            HD: mods.includes('HD'),
            DT: mods.includes('DT'),
...
async function addPlayDataBeatmap(playId, beatmapDetails, item, mods) {
    ...
    if (!maybePlay) {
        ...
        const playData = {
            ...
            combo: item.max_combo || 0,
            nmiss: item.statistics.miss || 0,
            hitJudgement: beatmapDetails.accuracy || 0,
            approachRate: beatmapDetails.ar || 0,
            circleSize: beatmapDetails.cs || 0,
            circleCount: beatmapDetails.count_circles || 0,
            sliderCount: beatmapDetails.count_sliders || 0,
            spinnerCount: beatmapDetails.count_spinners || 0,
            largeTickHits: item.statistics.large_tick_hit || 0,
            largeTickMisses: item.statistics.large_tick_miss || 0,
            sliderTailHits: item.statistics.slider_tail_hit || 0,
            sliderTailMisses: item.maximum_statistics.slider_tail_hit - item.statistics.slider_tail_hit || 0,
            bpm: beatmapDetails.bpm || 0,
            hitLength: beatmapDetails.hit_length || 0,
            drainRate: beatmapDetails.drain || 0,
            rating: beatmapDetails.difficulty_rating || 0,
            EZ: mods.includes('EZ'),
            HT: mods.includes('HT'),
            HD: mods.includes('HD'),
            DT: mods.includes('DT'),
